      ...
      <header className="main basics">
        <div className="main-header--content">
          ...
          <ul className="highlighted-technology-buttons">
            <li className="button button-js"><span>JS</span></li>
            <li className="button button-html5"><span>HTML5</span></li>
            <li className="button button-css3"><span>CSS3</span></li>
            <li className="button button-nodejs"><span>node</span></li>
          </ul>
